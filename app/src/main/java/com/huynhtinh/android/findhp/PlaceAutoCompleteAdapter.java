...
public class PlaceAutoCompleteAdapter
    ...
    public PlaceAutoCompleteAdapter(Context context, GoogleApiClient googleApiClient,
        ...
        super(context, R.layout.item_prediction);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (!mResultList.isEmpty()) {
            ...
            if (item != null) {
                TextView txtPrimary = convertView.findViewById(R.id.txt_primary);
                TextView txtSecondary = convertView.findViewById(R.id.txt_secondary);
                txtPrimary.setText(item.primaryText);
                txtSecondary.setText(item.secondText);
            }
        }
        return convertView;
    }
...
//                        Toast.LENGTH_SHORT).show();
    ...
    public class PlaceAutocomplete {
        ...
        public PlaceAutocomplete(CharSequence placeId, CharSequence primaryTexr, CharSequence secondText) {
            this.placeId = placeId;
            this.primaryText = primaryTexr;
